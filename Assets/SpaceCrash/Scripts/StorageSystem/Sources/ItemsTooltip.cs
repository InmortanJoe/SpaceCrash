...
public class ItemsTooltip : MonoBehaviour
{
        ...
        where T : Producible
    {
        ...
        {
            itemHolders[i].GetComponent<Distributor>().Initialize(caller.GetComponent<PlaceableObject2D>(), itemPair.Key, itemPair.Value);
        ...
        where T : Producible
    {
        ...
        {
            itemHolders[i].GetComponent<Distributor>().Initialize(caller.GetComponent<PlaceableObject2D>(), item);
